...
const Dashboard = () => {
  ...
  return (
    <div className='px-4 pt-10 md:px-10 flex-1'>
      ...
      {/* recent booking and monthly revenue portion */}
      <div className='flex flex-wrap items-start gap-6 mb-8 w-full'>

        {/*recent bookings*/}
        <div className='p-4 md:p-6 border border-border-color rounded-md max-w-lg w-full'>
          ...
          {data.recentBookings.map((booking, index)=>(
            <div className='mt-4 flex items-center justify-between'>
              ...
              <div className='flex items-center gap-2'>
                <div className='hidden md:flex items-center justify-center w-10 h-10 rounded-full bg-primary/10'>
                  <img src={assets.listIconColored} className='h-4.5 w-4.5' alt="" />
                </div>
                <div>
            ...
            <div className='flex items-center gap-2 font-medium'>
              ...
              <p className='px-3 py-0.5 border border-border-color rounded-full text-sm'>{booking.status}</p>
            </div>
        ...
        {/* monthly revenue */}
        <div className='p-4 md:p-6 mb-6 border border-border-color rounded-md w-full md:max-w-xs'>
