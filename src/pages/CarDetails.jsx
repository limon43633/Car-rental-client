  ...
  return car ? (
    <div className='px-6 md:px-16 lg:px-24 xl:px-32 mt-16'>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12'>
        {/* Left portion : car image and details*/}
        ...
        {/* Right portion: car booking from */}
        <form onSubmit={handleSubmit} className='shadow-lg h-max sticky top-18 rounded-xl p-6 space-y-6 text-gray-500'>
          ...
          <div className='flex flex-col gap-2'>
            ...
            <input type="date" className='border border-border-color px-3 py-2 rounded-lg' required id='pickup-date' min={new Date().toISOString().split('T')[0]}/>
          </div>

            {/*return date input field*/}
          <div className='flex flex-col gap-2'>
            <label htmlFor="return-date">Return Date</label>
            <input type="date" className='border border-border-color px-3 py-2 rounded-lg' required id='return-date'/>
          </div>
